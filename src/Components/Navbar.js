        ...
        <div className="navbar-container">
            ...
            <div className="navbar-right">
                <ul className="navbar-list">
                    <li><NavLink to="/about-us" className="navbar-list-item"><p>about us</p><span className="nav-list-item-span"></span></NavLink></li>
            ...
            <div className={active ? "navbar-list-inactive" : "navbar-list-sm"}>
                <NavLink to="/about-us" className="navbar-list-item"><p>about us</p><span className="nav-list-item-span"></span></NavLink>
